...
public class Ball implements Sprite {
    ...
    /**
     * sets the velocity according to given x and y.
     *
    ...
    public void moveOneStep(double dt) {
        ...
        if (currentCollision != null) {
            ...
            this.moveCenterToAlmostCollision(trajectory, collisionPoint);
            Velocity vel = block.hit(this, collisionPoint, this.getVelocity());
            this.velocity = vel;
        } else {
     ...
     *
     * @param trajectory     the balls trajectory line.
     * @param collisionPoint the collision point.
     */
    public void moveCenterToAlmostCollision(Line trajectory, Point collisionPoint) {
    ...
    /**
     * sets the color of the ball to random.
     */
